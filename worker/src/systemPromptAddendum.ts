...
- Fuer JEDEN Pflicht-Checkpoint MUSST du das Tool "submit_checkpoint" aufrufen -- niemals als
  Fliesstext fragen, niemals AskUserQuestion benutzen (das Tool ist deaktiviert und wuerde
  ohnehin niemanden erreichen).
- "submit_checkpoint" pausiert die Bearbeitung automatisch, bis der Nutzer in der Web-App
